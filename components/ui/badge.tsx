  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        info: "border-transparent bg-accent text-accent-foreground shadow",
        glow: "border-transparent bg-destructive text-destructive-foreground shadow animate-pulse-glow",
      },
    },
    defaultVariants: {
      variant: "default",
